...
const TopicIII: FC = () => (
  <Fragment>
    ...
    <Styled.InformativeTexts>
      ...
      adaptar o Site aos seus interesses e necessidades, bem como para compilar
      ...
      utilizados para acelerar suas atividades e experiências futuras no Site. A
      Unidas utiliza no Site os seguintes tipos de cookies:
    </Styled.InformativeTexts>
    ...
    <Styled.InformativeTexts>
      ...
      certas funcionalidades dos nossos sites poderão nãoz funcionar da maneira
      idealmente esperada. Para mais informações sobre como gerenciar suas
      preferências quanto à utilização de cookies diretamente em seu navegador,
      disponibilizamos os links abaixo para sua consulta:
    </Styled.InformativeTexts>
